...
public class Scene {
    ...
    static native void contextArc(double x, double y, double radius, double start, double end, boolean ccw);
    static native void contextBeginPath();
    static native void contextClosePath();
    static native void contextLineTo(double x, double y);
    static native void contextMoveTo(double x, double y);
    static native void contextRestore();
    static native void contextRotate(double angle);
    static native void contextSave();
    static native void contextStroke();
    static native void contextTranslate(double x, double y);
}
